...
<body>
    ...
    <div class="container-fluid pt-5">
            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    <h4 class="font-weight-semi-bold mb-4">Facture</h4>
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Prénom</label>
                            <input class="form-control" type="text" value="{{Auth::user()->name}}" name="name" placeholder="John">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Nom</label>
                            <input class="form-control" type="text" value="{{Auth::user()->lname}}" name="lname" placeholder="Doe">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control" type="text" value="{{Auth::user()->email}}" name="email" placeholder="example@email.com">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input class="form-control" type="text" value="{{Auth::user()->phone}}" name="phone" placeholder="+123 456 789">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Ligne 1</label>
                            <input class="form-control" type="text" value="{{Auth::user()->adress1}}" name="adress1" placeholder="123 Street">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Ligne 2</label>
                            <input class="form-control" type="text" value="{{Auth::user()->adress2}}" name="adress2" placeholder="123 Street">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Pays</label>
                            <input class="form-control" type="text" value="{{Auth::user()->country}}" name="country" placeholder="Morocco">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Vile</label>
                            <input class="form-control" type="text" value="{{Auth::user()->city}}" name="city" placeholder="New York">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p>{{$item->prod_qte}} x {{$item->products->nom}}</p>
                ...
                <div class="card border-secondary mb-5">
                    <div class="card-footer border-secondary bg-transparent">
                        <button type="submit" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Confirmer la Commande</button>
                    </div>
                </div>
            </div>
