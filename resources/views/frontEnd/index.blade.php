...
<body>
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        @foreach($categories as $item)
                            <a href="{{url('/categorie/'.$item->id)}}" class="nav-item nav-link">{{$item->nom}}</a>
                        @endforeach
                    </div>
                </nav>
            </div>
    ...
    <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Catégories</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
            @foreach($categories as $item)
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <a href="{{url('/categorie/'.$item->id)}}" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="{{asset('assets/uploads/category/'.$item->image)}}" alt="">
                        </a>
                        <h5 class="font-weight-semi-bold m-0">{{$item->nom}}</h5>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Top Produits</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    ...
                    <p>Abonnez-vous à notre Newsletter et recevez des mises à jours sur nos derniers produits</p>
                </div>
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control border-white p-4" placeholder="Email Ici">
